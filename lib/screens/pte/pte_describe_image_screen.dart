...
/// PTE-004 — Describe Image
/// Figma node 52:1642
class PteDescribeImageScreen extends StatefulWidget {
  const PteDescribeImageScreen({super.key});

  @override
  State<PteDescribeImageScreen> createState() => _PteDescribeImageScreenState();
}

class _PteDescribeImageScreenState extends State<PteDescribeImageScreen> {
  static const _prepTotalSeconds = 25;
  ...
  Widget _prepCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.white,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: AppColors.pte004PrepBorder),
        boxShadow: const [
          BoxShadow(
            color: Color(0x0D000000),
            offset: Offset(0, 1),
  ...
  Widget _imageCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.white,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: AppColors.pte004ChartBorder),
        boxShadow: const [
          BoxShadow(
            color: Color(0x0D000000),
            offset: Offset(0, 1),
        ...
        children: [
          Text(
            ...
            style: GoogleFonts.inter(
              ...
              fontWeight: FontWeight.w700,
              height: 20 / 15,
              color: AppColors.pte004ChartTitle,
            ),
          ),
          ...
          ClipRRect(
            ...
            child: Image.asset(
              'assets/icons/pte/describe_image_chart.png',
              width: double.infinity,
              fit: BoxFit.fitWidth,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.pte004ImageTipBg,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(color: AppColors.pte004ImageTipBorder),
            ),
            child: Row(
              children: [
                SvgPicture.asset(
                ...
                Expanded(
                  child: Text(
                    'You will have 40 secs to speak after preparation time',
                    style: GoogleFonts.inter(
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
                      height: 16 / 12,
  ...
  Widget _micCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: AppColors.pte004MicCardBg,
        boxShadow: const [
          BoxShadow(
            color: Color(0x0D000000),
            offset: Offset(0, 1),
          ...
          Text.rich(
            TextSpan(
              ...
              children: [
                const TextSpan(
                  text:
                      'When the recording starts, describe the image in detail. ',
                ),
                TextSpan(
                  text: '40 Secs',
                  style: GoogleFonts.inter(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'You cannot pause or replay in the real test. Try to cover all important points.',
              style: GoogleFonts.inter(
                fontSize: 12,
                fontWeight: FontWeight.w500,
                height: 16 / 12,
