...
/// PTE-003 — Repeat Sentence
/// Figma node 51:1204
class PteRepeatSentenceScreen extends StatefulWidget {
  const PteRepeatSentenceScreen({super.key});

  @override
  State<PteRepeatSentenceScreen> createState() =>
      _PteRepeatSentenceScreenState();
}

class _PteRepeatSentenceScreenState extends State<PteRepeatSentenceScreen> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'You get only one chance. There is no replay in the real test.',
              style: GoogleFonts.inter(
                fontSize: 12,
                fontWeight: FontWeight.w500,
                height: 16 / 12,
