...
/// PTE-005 — Re-tell Lecture
/// Figma node 55:33
class PteRetellLectureScreen extends StatefulWidget {
  const PteRetellLectureScreen({super.key});

  @override
  State<PteRetellLectureScreen> createState() => _PteRetellLectureScreenState();
}

class _PteRetellLectureScreenState extends State<PteRetellLectureScreen> {
        ...
        children: [
          ...
          Text.rich(
            TextSpan(
              ...
              children: [
                const TextSpan(
                  text: 'After the audio stops, you will have ',
                ),
                TextSpan(
                  text: '10 seconds',
                  style: GoogleFonts.inter(
                ...
                const TextSpan(text: ' to prepare. Then speak for up to '),
                TextSpan(
                  text: '40 seconds',
                  style: GoogleFonts.inter(
                    fontSize: 12,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'You can only play the audio once. Make good notes and retell as many key points as you want.',
              style: GoogleFonts.inter(
                fontSize: 12,
                fontWeight: FontWeight.w500,
                height: 16 / 12,
